...
def back():
	login()
def contact():
	os.system('xdg-open https://www.facebook.com/profile.php?id=100074788749098.')
	back()
def linex():
	print("""\x1b[37m----------------------------------------------""")
def cls():
...
\______   \____  ______
 ...
 |    |  / /_/  >___ \ 
 |____|  \___  /____  >
        /_____/     \/ \x1b[38;5;196mv6\x1b[37m
              """)
def info():
	print(f"""\x1b[37m----------------------------------------------
 AUTHOR     : PRAB3SH 
 GITHUB     : PRABESH.EXE
 FACEBOOK   : PRABESH HERE
...
def harryresults():
    ok_file_path = '/sdcard/PRABESH v1/PRABESH v1-OK.txt'
    cp_file_path = '/sdcard/PRABESH v1/PRABESH v1-CP.txt'
...
def contact():
	os.system('xdg-open https://www.facebook.com/प्रवेश पौडेल')
